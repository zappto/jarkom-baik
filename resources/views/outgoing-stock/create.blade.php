...
@section('title', 'Record Outgoing Stock')

@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <div class="px-5 py-4 border-b border-gray-100">
                <h3 class="text-base font-semibold text-gray-900">Record Outgoing Stock</h3>
            </div>
            <form method="POST" action="{{ route('outgoing-stock.store') }}" class="p-5 space-y-4">
                @csrf
                ...
                <div class="flex items-center gap-3 pt-2">
                    ...
                    <a href="{{ route('outgoing-stock.index') }}" class="px-4 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-150">Cancel</a>
                </div>
            </form>
        </div>
    </div>
